...
/*   Updated: 2024/09/20 13:33:24 by pwojnaro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_time(t_time *time_data, int time_to_die, int time_to_eat, int time_to_sleep)
{
...
int main()
{
    ...
    init_time(&time_data, 800, 200, 100);

    sleep(10);
    int elapsed = time_from_start(&time_data);
    printf("Time since start: %d ms\n", elapsed);
    return 0;
}
